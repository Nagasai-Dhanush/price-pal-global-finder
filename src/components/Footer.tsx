...
const Footer = () => {
  return (
    <footer className="bg-gloprice-darkerBg border-t border-gray-800 py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Logo />
            <p className="mt-4 text-gray-400">
              Find the best deals worldwide across multiple e-commerce platforms.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/alerts" className="text-gray-400 hover:text-white">Price Alerts</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} GloPrice. All rights reserved.
          </p>
